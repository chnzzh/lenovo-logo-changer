...
#[cfg(not(any(
    target_os = "windows",
    all(target_family = "windows"),
    target_os = "linux"
)))]
compile_error!(
    "This platform is not yet supported. Currently only Windows and Linux are supported. Please add support for your platform in src/platform/"
);
